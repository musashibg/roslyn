...
namespace Microsoft.CodeAnalysis.CSharp.Syntax
{
    public partial class IndexerDeclarationSyntax
    {
        ...
        public IndexerDeclarationSyntax Update(
        ...
        {
            return Update(attributeLists, decorators, modifiers, this.RefKeyword, type, explicitInterfaceSpecifier, thisKeyword, parameterList, accessorList, expressionBody, semicolonToken);
        }
    }
}
