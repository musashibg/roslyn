...
namespace Microsoft.CodeAnalysis.CSharp.Syntax
{
    public partial class PropertyDeclarationSyntax
    {
        ...
        public PropertyDeclarationSyntax Update(
        ...
        {
            return Update(attributeLists, decorators, modifiers, this.RefKeyword, type, explicitInterfaceSpecifier, identifier, accessorList, expressionBody, initializer, semicolonToken);
        }
    }
}
