...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal enum ErrorCode
    {
        ...
        ERR_UnsafeDecoratedMethodThisObjectCast = 7368,
        ERR_InvalidDecoratedMethodArgumentArrayCast = 7369,
        ERR_InvalidDecoratedMethodArgumentArrayUse = 7370,
        ERR_BadDecoratedMethodArgumentArrayIndex = 7371,
        ERR_DecoratedMethodArgumentArrayAssignedToOrdinaryArray = 7372,
        ERR_DecoratedMethodArgumentArrayRequired = 7373,
        ERR_DecoratedMethodArgumentArrayVariableRequired = 7374,
        ERR_OrdinaryArrayAssignedToDecoratedMethodArgumentArray = 7375,
        ERR_UnsafeDecoratedMethodArgumentCast = 7376,
        ERR_UnsafeValueAssignedToDecoratedMethodArgument = 7377,
        ERR_UnsafeDecoratedMethodReturnValueCast = 7378,
        ERR_UnsafeDecoratedMethodReturnValueRefParameterUse = 7379,
        ERR_UnsafeValueAssignedToDecoratedMethodReturnValue = 7380,
