...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal enum ErrorCode
    {
        ...
        ERR_DynamicBindingTimeInCompileTimeOnlyCode = 7355,
        ERR_BadMetaDecorationArgument = 7356,
        ERR_DuplicateNamedMetaDecorationArgument = 7357,
        ERR_BadNamedMetaDecorationArgument = 7358,
        ERR_BadMetaDecorationParamDefaultArgument = 7359,
        ...
        ERR_ThisReferenceInDecoratorOrMetaclass = 7366,
        ERR_InvalidSpliceLocation = 7367,
        ERR_UnsafeDecoratedMemberThisObjectCast = 7368,
        ERR_InvalidDecoratedMemberArgumentArrayCast = 7369,
        ERR_InvalidDecoratedMemberArgumentArrayUse = 7370,
        ERR_BadDecoratedMemberArgumentArrayIndex = 7371,
        ERR_DecoratedMemberArgumentArrayAssignedToOrdinaryArray = 7372,
        ERR_DecoratedMemberArgumentArrayRequired = 7373,
        ERR_DecoratedMemberArgumentArrayVariableRequired = 7374,
        ERR_OrdinaryArrayAssignedToDecoratedMemberArgumentArray = 7375,
        ERR_UnsafeDecoratedMemberArgumentCast = 7376,
        ERR_UnsafeValueAssignedToDecoratedMemberArgument = 7377,
        ERR_UnsafeDecoratedMemberReturnValueCast = 7378,
        ERR_UnsafeDecoratedMemberReturnValueRefParameterUse = 7379,
        ERR_UnsafeValueAssignedToDecoratedMemberReturnValue = 7380,
        ERR_UnsafeValueReturnedByDecoratorMethod = 7381,
        ERR_DecoratorMethodParameterModification = 7382,
        ERR_BadYieldInDecoratorMethod = 7383,
        ERR_LanguageFeatureNotSupportedInDecoratorOrMetaclass = 7384,
        ...
        ERR_MetaclassesInMultiplePartialTypeDeclarations = 7391,
        ERR_NotAMetaclass = 7392,
        ERR_AbstractMetaclass = 7393,
        ...
        ERR_UnsafeDecoratedMemberValueCast = 7404,
        ERR_UnsafeDecoratedMemberValueRefParameterUse = 7405,
        ERR_UnsafeValueAssignedToDecoratedMemberValue = 7406,
        ERR_DecoratedMemberValueRequired = 7407,
        ERR_IncompleteIndexerDecoratorMethodPair = 7408,
        ERR_IncompletePropertyDecoratorMethodPair = 7409,
        ERR_DecoratorDoesNotSupportConstructors = 7410,
        ERR_DecoratorDoesNotSupportDestructors = 7411,
